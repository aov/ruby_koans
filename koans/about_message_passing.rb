...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANSWER: 
    # 
    # Because "send" could already exist in the class
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # ANSWER:
    #
    # NoMethodError will not be caused
    # We could, for example log error or provide more dynamic behaviour
    # http://www.ruby-doc.org/core-2.1.3/BasicObject.html#method-i-method_missing
    #
    # NOTE:
    #
